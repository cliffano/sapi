 ...
 * class Sapi
 *
 * @param {String} key: Sensis API key, apply here http://developers.sensis.com.au/docs/getting_started/Apply_for_an_API_key
 * @param {String} url: Sensis API base URL - http://developers.sensis.com.au/docs/using_endpoints
 */
